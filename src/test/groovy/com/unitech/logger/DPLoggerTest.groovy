package com.unitech.logger

import org.slf4j.Logger
import spock.lang.Specification
import spock.lang.Unroll

class DPLoggerTest extends Specification {
    @Unroll
    def "Check trace"() {
        setup:
        Logger logger = Mock()
        DPLogger mockedDpLogger = new DPLogger(logger)
    ...
    def "Check escaping unsafe characters"() {
        setup:
        DPLogger dpLogger = DPLogger.getLogger(DPLoggerTest.class)
